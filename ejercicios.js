...
function canBuyProduct() {
    let precioConDescuento = 0.75*1500  // 0.75 es por el porcentaje del costo menos el porcentaje del descuento
    bool = precioConDescuento<=1150;
    if(bool){
